    ...
    <div className="ret-wrapper">
        ...
        <div className="ret-container" style={{ width: '100%' }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
            ...
            >
              ...
              <motion.h1 variants={fadeInUp} className="ret-heading-primary">
            ...
            >
              <div className="ret-media-placeholder" style={{ minHeight: '550px' }}>
                [RETAIL & CONSUMER HERO IMAGE / VIDEO PLACEHOLDER]
                <div style={{ fontSize: '0.8rem', color: '#6b7280', marginTop: '1rem', fontWeight: 'normal' }}>
                  Premium retail store • Point-of-sale • E-commerce
                </div>
              </div>
            </motion.div>

            <motion.div initial="hidden" animate="visible" variants={staggerContainer} style={{ width: '100%', maxWidth: '800px', margin: '0 auto' }}>
              <motion.p variants={fadeInUp} className="ret-subheading" style={{ marginBottom: '1.5rem' }}>
              ...
              <motion.p variants={fadeInUp} className="ret-paragraph" style={{ marginBottom: '2rem' }}>
      ...
      <section className="ret-section ret-section-alt">
        <div className="ret-container">
          ...
          >
            <motion.h2 variants={fadeInUp} className="ret-heading-secondary">Retail Is More Than Selling Products. It's an Entire Ecosystem.</motion.h2>
          </motion.div>
          ...
          >
            <div className="ret-media-placeholder" style={{ minHeight: '400px' }}>
              [CONNECTED RETAIL ECOSYSTEM IMAGE / VIDEO PLACEHOLDER]
            </div>
          </motion.div>
          ...
          >
            <motion.p variants={fadeInUp} className="ret-subheading">Connect every important part of your retail operation.</motion.p>
          ...
          <div className="ret-grid-3">
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="ret-glass-card">
            ...
            {[
              ...
              >
                ...
                <div className="ret-course-media">
                  <div className="ret-media-placeholder" style={{ minHeight: '100%', padding: '1rem' }}>
      ...
      <section className="ret-section ret-section-alt">
        <div className="ret-container">
          <motion.div
            ...
            style={{ textAlign: 'center', marginBottom: '3rem' }}
          >
            <motion.h2 variants={fadeInUp} className="ret-heading-secondary">Turn Every Customer Interaction Into a Better Experience.</motion.h2>
          </motion.div>
          ...
          <motion.div
            ...
            style={{ marginBottom: '3rem' }}
          >
            <div className="ret-media-placeholder" style={{ minHeight: '500px' }}>
              [RETAIL CRM DASHBOARD IMAGE / VIDEO PLACEHOLDER]
              <div style={{ fontSize: '0.8rem', color: '#6b7280', marginTop: '1rem', fontWeight: 'normal' }}>
                Customer profiles • Purchase history • Segments • Leads • Follow-ups
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            style={{ textAlign: 'center', marginBottom: '4rem', maxWidth: '800px', margin: '0 auto 4rem auto' }}
          >
            <motion.p variants={fadeInUp} className="ret-subheading">Connect customer relationships across every retail touchpoint.</motion.p>
            <motion.p variants={fadeInUp} className="ret-paragraph" style={{ margin: '0 auto' }}>
          ...
          <div className="ret-grid-3" style={{ marginBottom: '4rem' }}>
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="ret-glass-card" style={{ padding: '2rem' }}>
                <div className="ret-ambient-border-glow"></div>
          ...
          <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="ret-journey">
      ...
      <section className="ret-section">
        <div className="ret-container">
          <motion.div
            ...
            style={{ textAlign: 'center', marginBottom: '3rem' }}
          >
            <motion.h2 variants={fadeInUp} className="ret-heading-secondary">Connect the Business Behind Every Sale.</motion.h2>
          </motion.div>
          ...
          >
            <div className="ret-media-placeholder" style={{ minHeight: '500px' }}>
              [RETAIL INVENTORY MANAGEMENT IMAGE / VIDEO PLACEHOLDER]
              <div style={{ fontSize: '0.8rem', color: '#6b7280', marginTop: '1rem', fontWeight: 'normal' }}>
                Stock levels • Alerts • Locations • Movements
              </div>
            </div>
          </motion.div>
        ...
        <div className="ret-container">
          ...
          <div style={{ marginBottom: '8rem' }}>
            <motion.div
              ...
              style={{ textAlign: 'center', marginBottom: '3rem' }}
            >
              <motion.h2 variants={fadeInUp} className="ret-heading-secondary">Turn Retail Data Into Business Intelligence.</motion.h2>
            </motion.div>
            ...
            <motion.div
              ...
              style={{ marginBottom: '3rem' }}
            >
              <div className="ret-media-placeholder" style={{ minHeight: '600px' }}>
                [RETAIL ANALYTICS DASHBOARD IMAGE / VIDEO PLACEHOLDER]
              </div>
            </motion.div>
            ...
            <div className="ret-grid-3" style={{ gap: '1.5rem' }}>
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="ret-glass-card" style={{ padding: '1.5rem' }}>
                <div className="ret-ambient-border-glow"></div>
