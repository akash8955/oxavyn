    ...
    <div className="agcy-wrapper">
        ...
        <div className="agcy-container" style={{ width: '100%' }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
            ...
            <motion.div
              ...
              style={{ width: '100%', maxWidth: '1100px', margin: '2rem auto' }}
            >
              <div className="agcy-media-placeholder" style={{ minHeight: '550px' }}>
                [AGENCY & CONSULTANCY HERO IMAGE / VIDEO PLACEHOLDER]
                <div style={{ fontSize: '0.8rem', color: '#6b6365', marginTop: '1rem', fontWeight: 'normal' }}>
                  Modern consulting team • Creative agency meeting • Client presentation • Agency management dashboard
                </div>
              </div>
            </motion.div>

            {/* SUBHEADING / PARAGRAPH / CTA */}
            <motion.div initial="hidden" animate="visible" variants={staggerContainer} style={{ width: '100%', maxWidth: '800px', margin: '0 auto' }}>
              <motion.p variants={fadeInUp} className="agcy-subheading" style={{ marginBottom: '1.5rem' }}>
                A connected digital ecosystem for client relationships, projects, teams, operations, finance, analytics, and automation.
              </motion.p>
              <motion.p variants={fadeInUp} className="agcy-paragraph" style={{ marginBottom: '2rem' }}>
      ...
      <section className="agcy-section agcy-section-alt">
        <div className="agcy-container">
          ...
          {/* HEADING */}
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} style={{ textAlign: 'center', marginBottom: '3rem' }}>
            <motion.h2 variants={fadeInUp} className="agcy-heading-secondary">Your Clients, Projects, Teams, and Operations — Connected.</motion.h2>
          </motion.div>

          {/* MEDIA */}
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} style={{ marginBottom: '3rem' }}>
            <div className="agcy-media-placeholder" style={{ minHeight: '400px' }}>
              [CONNECTED AGENCY ECOSYSTEM IMAGE / VIDEO PLACEHOLDER]
            </div>
          </motion.div>

          {/* SUBHEADING / PARAGRAPH */}
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto 4rem auto' }}>
            <motion.p variants={fadeInUp} className="agcy-subheading">One connected environment for the complete agency lifecycle.</motion.p>
            <motion.p variants={fadeInUp} className="agcy-paragraph" style={{ margin: '0 auto' }}>
          ...
          <div className="agcy-grid-3">
            {[
              ...
              <motion.div key={idx} variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="agcy-glass-card">
      ...
      <section className="agcy-section">
        <div className="agcy-container">
          ...
          {/* HEADING */}
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} style={{ textAlign: 'center', marginBottom: '3rem' }}>
            <motion.h2 variants={fadeInUp} className="agcy-heading-secondary">Turn Every Client Relationship Into a Connected Experience.</motion.h2>
          </motion.div>

          {/* MEDIA */}
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} style={{ marginBottom: '3rem' }}>
            <div className="agcy-media-placeholder" style={{ minHeight: '500px' }}>
              [AGENCY CRM DASHBOARD IMAGE / VIDEO PLACEHOLDER]
            </div>
          </motion.div>

          {/* SUBHEADING / PARAGRAPH */}
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto 4rem auto' }}>
            <motion.p variants={fadeInUp} className="agcy-subheading">Manage leads, clients, proposals, communication, and relationships from one place.</motion.p>
            <motion.p variants={fadeInUp} className="agcy-paragraph" style={{ margin: '0 auto' }}>
          ...
          <div className="agcy-grid-3" style={{ marginBottom: '4rem' }}>
            {[
              ...
              <motion.div key={idx} variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="agcy-glass-card" style={{ padding: '2rem' }}>
                <div className="agcy-ambient-border-glow"></div>
          ...
          <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="agcy-journey">
      ...
      <section className="agcy-section agcy-section-alt">
        <div className="agcy-container">
          ...
          {/* HEADING */}
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} style={{ textAlign: 'center', marginBottom: '3rem' }}>
            <motion.h2 variants={fadeInUp} className="agcy-heading-secondary">Turn Projects and Operations Into One Organized System.</motion.h2>
          </motion.div>

          {/* MEDIA */}
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} style={{ marginBottom: '3rem' }}>
            <div className="agcy-media-placeholder" style={{ minHeight: '500px' }}>
              [AGENCY PROJECT & ERP MANAGEMENT IMAGE / VIDEO PLACEHOLDER]
            </div>
          </motion.div>

          {/* SUBHEADING / PARAGRAPH */}
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto 4rem auto' }}>
            <motion.p variants={fadeInUp} className="agcy-subheading">Connect projects, people, finance, resources, and business operations.</motion.p>
            <motion.p variants={fadeInUp} className="agcy-paragraph" style={{ margin: '0 auto' }}>
      ...
      <section className="agcy-section">
        <div className="agcy-container">
          ...
          <div style={{ marginBottom: '8rem' }}>
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} style={{ textAlign: 'center', marginBottom: '3rem' }}>
              <motion.h2 variants={fadeInUp} className="agcy-heading-secondary">Turn Agency Data Into Business Intelligence.</motion.h2>
            </motion.div>

            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} style={{ marginBottom: '3rem' }}>
              <div className="agcy-media-placeholder" style={{ minHeight: '600px' }}>
                [AGENCY ANALYTICS DASHBOARD IMAGE / VIDEO PLACEHOLDER]
              </div>
            </motion.div>

            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} style={{ textAlign: 'center', marginBottom: '4rem', maxWidth: '800px', margin: '0 auto 4rem auto' }}>
              <motion.p variants={fadeInUp} className="agcy-subheading">Understand your clients, projects, revenue, team, and business performance.</motion.p>
              <motion.p variants={fadeInUp} className="agcy-paragraph" style={{ margin: '0 auto' }}>
      ...
      <section className="agcy-section agcy-section-alt">
        <div className="agcy-container">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} style={{ textAlign: 'center', marginBottom: '3rem' }}>
            <motion.h2 variants={fadeInUp} className="agcy-heading-secondary">From First Client Conversation to Final Delivery.</motion.h2>
          </motion.div>

          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} style={{ marginBottom: '3rem' }}>
            <div className="agcy-media-placeholder" style={{ minHeight: '500px' }}>
              [CONNECTED AGENCY WORKFLOW IMAGE / VIDEO PLACEHOLDER]
            </div>
          </motion.div>

          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto 4rem auto' }}>
            <motion.p variants={fadeInUp} className="agcy-subheading">One connected workflow across sales, clients, projects, teams, finance, and management.</motion.p>
            <motion.p variants={fadeInUp} className="agcy-paragraph" style={{ margin: '0 auto' }}>
          ...
          <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="agcy-journey" style={{ marginBottom: '4rem' }}>
